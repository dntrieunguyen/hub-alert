...
export class DeepSeekValidator {
    ...
    private static validateSingleItem(
        ...
        const rawConf = Number(raw.aiConfidence);
        ...
        return {
            eventId: event.id,
            isValuable: Boolean(raw.isValuable !== false),
            isNewInformation: Boolean(raw.isNewInformation !== false),
            category,
            ...
            duplicateOfEventId: typeof raw.duplicateOfEventId === 'string' && raw.duplicateOfEventId.trim() ? raw.duplicateOfEventId.trim() : null,
        };
    }
}
